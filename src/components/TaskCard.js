...
const TaskCard = ({ name, priority, completed, completionLevel, teamMembers, type, description, status, deadline }) => {
    ...
    return (
        <div class="card col-sm" style={{ width: "30rem", height: "10rem" }}>
            <ul style={{ paddingLeft: 0, margin: 0, }}>
                ...
                <li class="list-group-item list-group-item-action list-group-item-success">Priority : {priority}</li>
